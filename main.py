...
customer = "llC sting " # Едрпоу адреса назва компании
shipper = "str" # повне найменування, місцезнаходження / П. І.Б., місце проживання
consignee = "llC sting" # повне найменування, місцезнаходження / П. І.Б., місце проживання
...
data = {
    ...
    'L10': customer, # замовник dap \ fca
    'L11': shipper, # Вантажовідправник
    'L12': consignee, # Вантажовідправник
